...
public class UsuarioController implements Serializable {
    ...
    public void iniciarSesion() throws Exception{
        try {
            ...
            if(selected != null){
                FacesContext.getCurrentInstance().getExternalContext().redirect("/HospitalVG/faces/index.xhtml");
            }else{
    ...
    public void ingresarCifrando(){
        selected.setPwdusu(Funciones.encriptar(selected.getPwdusu()));
        create();
    }
    
    public void actualizarCifrando(){
        if(selected .getPwdusu()!=null){
            selected.setPwdusu(Funciones.encriptar(selected.getPwdusu()));
        }
        update();
    }
    ...
    public static class UsuarioControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Usuario) {
                ...
                return getStringKey(o.getNumusu());
            } else {
