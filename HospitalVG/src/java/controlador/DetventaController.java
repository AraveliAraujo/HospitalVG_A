...
public class DetventaController implements Serializable {
    ...
    protected void initializeEmbeddableKey() {
        selected.setDetventaPK(new modelo.entity.DetventaPK());
    }
    ...
    public Detventa getDetventa(modelo.entity.DetventaPK id) {
    ...
    public static class DetventaControllerConverter implements Converter {
        ...
        modelo.entity.DetventaPK getKey(String value) {
            modelo.entity.DetventaPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new modelo.entity.DetventaPK();
            key.setNummed(Long.parseLong(values[0]));
            key.setNcodDoc(Long.parseLong(values[1]));
            return key;
        }

        String getStringKey(modelo.entity.DetventaPK value) {
